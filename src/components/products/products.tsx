...
export default function Products() {
    return (
        <div className="flex justify-center items-center bg-slate-50 lg:px-16">
            <div className="2xl:mx-auto 2xl:container py-12 px-4 sm:px-6 xl:px-20 2xl:px-0 w-full">
                <div className="flex flex-col jusitfy-center items-center space-y-10">
                    <div className="flex flex-col justify-center items-center ">
                        <h1 className="text-3xl xl:text-4xl font-semibold leading-7 xl:leading-9 text-slate-800">Shop By Category</h1>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-4 w-full">
                        <div className="relative group flex justify-center items-center h-full w-full">
                            ...
                            <button className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-400 bottom-4 z-10 absolute text-base font-medium leading-none text-slate-800 py-3 w-36 bg-white">Women</button>
                        ...
                        <div className="flex flex-col space-y-4 md:space-y-8 mt-4 md:mt-0">
                            <div className="relative group flex justify-center items-center h-full w-full">
                                ...
                                <button className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-400 bottom-4 z-10 absolute text-base font-medium leading-none text-slate-800 py-3 w-36 bg-white">Shoes</button>
                                <div className="absolute opacity-0 group-hover:opacity-100 transition duration-500 bottom-3 py-6 z-0 px-20 w-36 bg-white bg-opacity-50"></div>
                            </div>
                            <div className="relative group flex justify-center items-center h-full w-full">
                                ...
                                <button className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-400 bottom-4 z-10 absolute text-base font-medium leading-none text-slate-800 py-3 w-36 bg-white">Watches</button>
                                <div className="absolute opacity-0 group-hover:opacity-100 transition duration-500 bottom-3 py-6 z-0 px-20 w-36 bg-white bg-opacity-50"></div>
                            </div>
                        </div>
                        ...
                        <div className="relative group justify-center items-center h-full w-full hidden lg:flex">
                            ...
                            <button className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-400 bottom-4 z-10 absolute text-base font-medium leading-none text-slate-800 py-3 w-36 bg-white">Accessories</button>
                            <div className="absolute opacity-0 group-hover:opacity-100 transition duration-500 bottom-3 py-6 z-0 px-20 w-36 bg-white bg-opacity-50"></div>
                        </div>
